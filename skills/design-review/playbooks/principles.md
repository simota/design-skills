...
The vocabulary an impression restates into. This is the step that turns "it
looks cheap" into a claim somebody can disagree with and settle.

## How to use this

**The impression comes first and is never edited to fit.** Write what happened —
where the eye went, in what order, what it skipped, what it caught on, how the
...
| Principle | The impression it explains | What to look for |
|---|---|---|
...
- **Naming several principles for one impression.** Pick the one that explains
  it. A list of five reads as thoroughness and means the cause was not found
- **Principles with no impression behind them.** Auditing the list top to bottom
  produces findings nobody felt. The impression is the filter
- **Treating a principle as a rule.** These describe how looking works, not what
  is permitted. A deliberate violation that reads well is a good design
- **Grading the whole from one principle.** The verdict is a separate step
